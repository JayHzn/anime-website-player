// ── JetAnimes source (on.jetanimes.com) — Mobile (React Native) version ──
// Identical to extension/sources/jetanimes.js: it already sets an explicit User-Agent
...
export class JetAnimesSource {
  ...
  async getVideoUrl(episodeId) {
    ...
    // Probe every server concurrently: each runs the admin-ajax call then resolves its embed.
